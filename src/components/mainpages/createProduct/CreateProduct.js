...
function CreateProduct() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      const res = await axios.post("https://webdoanbe.onrender.com/api/upload", formData, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(onEdit){
        const updateProduct = await axios.put(`https://webdoanbe.onrender.com/api/products/${product._id}`, {...product, images}, {
            headers: {Authorization: token}
        })
        Swal.fire({
          position: "center",
        ...
        const createProduct = await axios.post('https://webdoanbe.onrender.com/api/products', {...product, images}, {
            headers: {Authorization: token}
        })
        Swal.fire({
          position: "center",
